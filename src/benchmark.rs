...
//     vienna_avg: f64,
//     min_vienna: (&'a str, f64),
//     max_vienna: (&'a str, f64),
//     std_vienna: f64,

//     score_distribution_vienna: [i32; 5],

//     top_scores_vienna:    Vec<(&'a str, f64)>,
//     bottom_scores_vienna: Vec<(&'a str, f64)>,

//     nussinov_avg: f64,
//     min_nussinov: (&'a str, f64),
//     max_nussinov: (&'a str, f64),
//     std_nussinov: f64,

//     score_distribution_nussinov: [i32; 5],

//     top_scores_nussinov:    Vec<(&'a str, f64)>,
//     bottom_scores_nussinov: Vec<(&'a str, f64)>, 
...
//     fn std_dev(avg: &f64, count: &i32, score_list: &Vec<(&'a str, f64)>) -> f64 {
//         let mut score_sum = 0.0;
//         let count1 = *count as usize;
//         for i in 0..count1 {
//             score_sum += (score_list[i].1 - avg).powf(2.0);
//         }
//         (score_sum / (count - 1) as f64  - avg) as f64
//     }
